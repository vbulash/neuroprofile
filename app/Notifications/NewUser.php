    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
			...
			->line("В целях безопасности пароль пользователя никогда не пересылается по почте. " .
				sprintf("Если вы забудете свой пароль - воспользуйтесь функцией его сброса на диалоге входа в \"%s\"и получите дальнейшие инструкции в электронной почте.", env('APP_NAME')));
    }
