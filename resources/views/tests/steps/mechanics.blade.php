...
@section('form.fields')
	@php
		...
		if (!isset($heap['step-mechanics']) && $mode == config('global.create')) {
		    $fields = [['name' => 'cue', 'title' => 'Общая подсказка к вопросам теста', 'required' => false, 'type' => 'text'], ['name' => 'set_id', 'title' => 'Набор вопросов', 'required' => false, 'type' => 'select', 'options' => $sets], ['title' => 'Дополнительные механики нейротеста', 'type' => 'heading'], ['name' => 'face', 'title' => 'Нейросеть (распознавание лица)', 'required' => false, 'type' => 'checkbox'], ['name' => 'eye', 'title' => 'Eye-tracking (отслеживание движения зрачков глаз)', 'required' => false, 'type' => 'checkbox'], ['name' => 'mouse', 'title' => 'Mouse-tracking (отслеживание движения курсора мыши)', 'required' => false, 'type' => 'checkbox'], ['name' => 'mode', 'type' => 'hidden', 'value' => $mode], ['name' => 'test', 'type' => 'hidden', 'value' => $test], ['name' => 'step-mechanics', 'type' => 'hidden', 'value' => true]];
		} else {
		    $fields = [
