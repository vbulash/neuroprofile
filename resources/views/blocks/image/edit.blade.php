...
@section('steps')
	@php
		$steps = match (strval($kind)) {
		    \App\Models\BlockKind::Parent->value, \App\Models\BlockKind::Kid->value => [['title' => 'Блок-предок', 'active' => true, 'context' => 'parent', 'link' => route('parents.index')], ['title' => 'Блок-потомок', 'active' => false, 'context' => 'profile']],
