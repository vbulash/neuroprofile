...
@section('steps')
	@php
		$steps = [['title' => 'Набор вопросов', 'active' => true, 'context' => 'set'], ['title' => 'Вопросы', 'active' => false, 'context' => 'question'], ['title' => 'Изображения вопросов', 'active' => false, 'context' => 'part']];
	@endphp
@endsection

@section('interior')
	<div class="block-header block-header-default">
		<a href="{{ route('sets.create') }}" class="btn btn-primary">Добавить набор вопросов</a>
	</div>
